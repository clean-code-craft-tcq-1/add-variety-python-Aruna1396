...
class TypewiseTest(unittest.TestCase):
    ...
    def test_check_and_alert_yields_apt_alerts_for_breaches(self):
        ...
        self.assertEqual(typewise_alert.check_and_alert('controller', {'coolingType': 'HI_ACTIVE_COOLING'}, 40), 'NORMAL')
        self.assertEqual(typewise_alert.check_and_alert('console', {'coolingType': 'HI_ACTIVE_COOLING'}, 140), 'CONSOLE_OUTPUT_SENT')
